...
export default {
  ...
  data() {
    return {
      searchBarData: [
        [
          { type: 'multiple-date', value: ['2018-04-03', '2018-04-05'], key1: 'startDate', key2: 'endDate', placeholder1: '开始日期', placeholder2: '结束日期' },
          { type: 'date', value: null, key: 'buyDate', placeholder: '购买日期' },
  ...
  methods: {
    ...
    clickEdit(index, row) {
      this.$setOKV(this.add, { visiable: true, data: { type: 'edit', obj: row }})
    },
    showAdd() {
      this.$setOKV(this.add, { visiable: true, data: { type: 'add' }})
    },
